...
const Day3Flow = ({ campaignId, campaignTitle, isAdmin, completed, onBack, onComplete, onNavigateNext }: Day3FlowProps) => {
        ...
        >
          ...
          {step === 1 && (
            <MediaSlider
              ...
              instruction="Súbelos a tu estado Y mándalos directo a quienes hacen gym"
              totalSlots={2}
              assets={videoAssets}
              ...
              inspirationMessages={[
                "Amiga, ¿ya viste lo nuevo para el gym? Está increíble — mira este video 🔥",
          ...
          {step === 2 && (
            <MediaSlider
              ...
              onDownload={downloadAsset}
              inspirationMessages={[
                "¿Viste el video que te mandé? Aquí está la foto del outfit por si lo quieres ver mejor 📸",
                "Te dejo la imagen para que lo veas con calma — si te gusta me dices y te lo aparto 😊"
              ]}
...
const Step1Mission = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-8 py-8">
    ...
    <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground leading-tight">
      Hoy vas con las que se mueven
    </h1>
    <p className="text-base text-muted-foreground leading-relaxed max-w-sm">
      Las clientas que hacen ejercicio ya tienen el hábito — solo necesitan el outfit correcto. Hoy les muestras que Price Shoes tiene lo que buscan para verse increíbles en el gym y corriendo.
    </p>
    <p className="text-sm italic max-w-xs" style={{ color: "hsl(330, 85%, 55%)" }}>
      "No estás vendiendo ropa deportiva — estás vendiendo cómo se van a sentir cuando lleguen al gym."
    </p>
  </div>
);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-8 py-8">
      ...
      <h1 className="font-display text-2xl md:text-3xl font-bold text-foreground leading-tight">
        ¿Ya subiste los videos a tu estado?
      </h1>
