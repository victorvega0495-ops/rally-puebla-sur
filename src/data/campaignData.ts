...
days: [
      ...
      ...Array.from({ length: 5 }, (_, i) => ({
        day: i + 3,
        emoji: ["🎯", "🎁", "👥", "⭐", "🔄"][i],
        type: (["prospeccion", "activacion", "prospeccion", "seguimiento", "seguimiento"] as const)[i],
        typeLabel: ["Prospección", "Activación + Promo", "Prospección", "Seguimiento", "Seguimiento"][i],
        focus: `Día ${i + 3}`,
