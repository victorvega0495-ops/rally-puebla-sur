...
days: [
      ...
      ...Array.from({ length: 6 }, (_, i) => ({
        day: i + 2,
        emoji: ["🔥", "🎯", "🎁", "👥", "⭐", "🔄"][i],
        type: (["activacion", "prospeccion", "activacion", "prospeccion", "seguimiento", "seguimiento"] as const)[i],
        typeLabel: ["Activación", "Prospección", "Activación + Promo", "Prospección", "Seguimiento", "Seguimiento"][i],
        focus: `Día ${i + 2}`,
